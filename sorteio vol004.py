...
while True:
 ...
 "se você responder com o numero 2 você podera retirar algo da lista \n" \
 "se você responder com o numero 3 você poderar visualizar a lista ")
 print("")
 ...
 if resposta == '0':
  ...
  #verifica se numero é 2
   ...
   if retirar_itens <= quantos_indice and retirar_itens >= 0 :
      ...
      for nome_dos_itens, valor_dos_itens in enumerate(lista):
           print(f"{nome_dos_itens} : {valor_dos_itens}")
  ...
  #se a respota do usuario for 3 ele ira printar todos os itens detro da lista
 elif resposta == "3":
         for lista1, lista001 in enumerate(lista):
            print(f"{lista1 } : {lista001}")
         print("o menu principal vai retorna em 5 segundos")
         time.sleep(5)
